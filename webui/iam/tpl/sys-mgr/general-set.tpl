<div class="iam-div-light" style="padding: 5px 10px">
  ...
  <div id="iam-sysmgr-generalset" class="form-horizontal">
    <div class="iam-form-group-title">
      {[=l4i.T("%s Information", l4i.T("Service"))]}
    </div>
        ...
        <tr>
          ...
          <td width="40%">
            <input
              ...
              class="form-control"
              name="service_name"
              value="{[=it._items.service_name]}"
            />
          </td>
          <td>
            <div class="iam-callout iam-callout-primary">
              <h4>IAM Service Name</h4>
              <p>Will be displayed in the website name, e-mail signature ...</p>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input
              ...
              value="{[=it._items.webui_banner_title]}"
            />
          </td>
          <td>
            <div class="iam-callout iam-callout-primary">
              <h4>Banner Title</h4>
              <p>Will be displayed in the website banner</p>
            </div>
          </td>
        </tr>
      </tbody>
    ...
    <div class="iam-form-group-title">
      {[=l4i.T("%s Settings", l4i.T("User Registration"))]}
    </div>
      ...
      <tbody>
        <tr>
          ...
          <td width="40%">
            <div class="checkbox">
              <label>
                <input type="checkbox" name="user_reg_disable" value="1" {[ if
                (it._items.user_reg_disable == "1") { ]} checked {[ } ]}>
              </label>
            </div>
          </td>
          <td>
            <div class="iam-callout iam-callout-primary">
              ...
              <p>Disable Visitors to create new account</p>
            </div>
          </td>
        </tr>
      </tbody>
        ...
        <tr>
          ...
          <td width="40%">
            <input
              ...
              value="{[=it._items.service_login_form_alert_msg]}"
            />
          </td>
          <td></td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <button
              ...
              onclick="iamSys.GeneralSetCommit()"
            >
              {[=l4i.T("Save")]}
            </button>
          </td>
