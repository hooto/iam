...
<table width="100%">
  <tr>
    <td>
      <!-- TODO <form id="gir0c7" action="#" class="form-inlines">
...
<div id="ids-myapp-insts-alert" class="hide" style="margin:20px 0;"></div>
...
<table class="table table-hover">
  ...
  <tbody id="ids-myapp-insts"></tbody>
</table>

<div id="ids-myapp-insts-pager"></div>


<script id="ids-myapp-insts-tpl" type="text/html">
{[~it.items :v]}
    <tr>
      <td>{[=v.meta.id]}</td>
      <td>{[=v.app_id]}</td>
...
<script id="ids-myapp-insts-pager-tpl" type="text/html">
