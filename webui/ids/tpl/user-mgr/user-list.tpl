...
<table width="100%">
  <tr>
    <td>
      <form id="ids-usermgr-list-query" action="#" class="form-inlines">
...
<div id="ids-usermgr-list-alert" class="hide" style="margin:20px 0;"></div>
...
<table class="table table-hover">
  ...
  <tbody id="ids-usermgr-list"></tbody>
</table>
<div id="ids-usermgr-list-pager"></div>

<script id="ids-usermgr-list-tpl" type="text/html">
{[~it.items :v]}
    <tr>
      <td>{[=v.meta.name]}</td>
      <td>{[=v.name]}</td>
...
<script id="ids-usermgr-list-pager-tpl" type="text/html">
